<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="WebApplication13.WebForm3" %>
...
<body>
<h1>Edit Page</h1>
<h2>Instruction : Enter the address name that you wanted to change in the "Old Name" and enter the new information in the new list. </h2>
<form id="form1" runat="server">
<asp:Panel ID="myPanel" runat="server" CssClass="box">
<br />
<br />
Old Name : 
<asp:TextBox runat="server" ID="txtOldName" Width="80"></asp:TextBox>
<br />
<br />
New Name : 
